...
document.getElementById('form-levantamento').addEventListener('submit', async (e) => {
    ...
    const btnSubmit = document.querySelector('button[type="submit"]');
    const livros = {
        doisAlicerces: parseInt(document.getElementById('livro-dois-alicerces').value) || 0,
        passosJesus: parseInt(document.getElementById('livro-passos-jesus').value) || 0,
        pastaEbi: parseInt(document.getElementById('livro-pasta-ebi').value) || 0,
        agendaFloral: parseInt(document.getElementById('livro-agenda-floral').value) || 0,
        tresEmUm: parseInt(document.getElementById('livro-tres-em-um').value) || 0,
        descobrindoArrependimento: parseInt(document.getElementById('livro-descobrindo-arrependimento').value) || 0,
        descobrindoAvivamento: parseInt(document.getElementById('livro-descobrindo-avivamento').value) || 0,
        descobrindoFruto: parseInt(document.getElementById('livro-descobrindo-fruto').value) || 0,
        descobrindoCarater: parseInt(document.getElementById('livro-descobrindo-carater').value) || 0,
        ovelhaPerdida: parseInt(document.getElementById('livro-ovelha-perdida').value) || 0,
        talentos: parseInt(document.getElementById('livro-talentos').value) || 0,
        semeador: parseInt(document.getElementById('livro-semeador').value) || 0,
        filhoDono: parseInt(document.getElementById('livro-filho-dono').value) || 0,
        miguelEscolhas: parseInt(document.getElementById('livro-miguel-escolhas').value) || 0,
